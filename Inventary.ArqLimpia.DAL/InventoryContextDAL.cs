...
namespace Inventary.ArqLimpia.DAL
{
    public class InventoryContextDAL
    {
        ...
        public IMongoCollection<PurchaseEN> Purchase => _database.GetCollection<PurchaseEN>("Purchase");
        public IMongoCollection<PurchaseProductEN> PurchaseProduct => _database.GetCollection<PurchaseProductEN>("PurchaseProduct");
        public IMongoCollection<SinglePurchaseEN> SinglePurchase => _database.GetCollection<SinglePurchaseEN>("SinglePurchase");
    }
}
